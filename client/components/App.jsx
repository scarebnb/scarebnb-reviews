...
class App extends React.Component {
	...
	componentDidMount() {
		...
		// uncomment for deployment referencing EC2 instance
			...
			<div className={styles.reviewSection}>
				...
				<div className={styles.wrapper}>
					...
					<div className={styles.reviews}>
						...
						<button type='button' className={styles.btn} onClick={this.showAll} id={styles.showAll}>
				...
				{showAllReviews ? (
					<ReviewsModal reviews={reviews} averages={averages} tags={tags} showAll={this.showAll} />
				) : null}
				<hr />
			</div>
		);
